...
the RERAG frontend (`frontend/fro`), which lived at
github.com/PieterdenEngelse/RERAG until the owner deleted it on 2026-09-05.
The URL is left unlinked deliberately: it is provenance, not somewhere to go,
and nothing here depends on it. The styling rules below apply here without
exception.
